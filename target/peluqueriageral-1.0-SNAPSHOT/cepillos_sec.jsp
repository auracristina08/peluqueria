<%-- 
    Document   : cepillos_sec
    Created on : 11/10/2024, 10:02:48 p. m.
    Author     : aurcr
--%>
...
<head>
    ...
    <title>Cepillos Secadores</title>
    <style>
        /* Estilos generales */
        body {
...
<body>
    ...
    <header>
        <h1>Nuestros Cepillos Secadores</h1>
    </header>

    <main class="products-container">
        <!-- Producto 1 -->
        <section class="product">
            <img src="https://carulla.vtexassets.com/arquivos/ids/2335198-800-auto?v=637378008638400000&width=800&height=auto&aspect=true" alt="Cepillo Secador">
            <h2>Cepillo Secador Aire Caliente</h2>
            <p>Puedes utilizarlo con muchos propositos: ya sea que lo utilices como secador de pelo, estilizador, voluminizador o alisador, este secador de aire caliente será una de tus nuevas herramientas de peinado favoritas para crear estilos de salón sin esfuerzo y sin encrespamiento, desde la comodidad de tu propia casa.</p>
