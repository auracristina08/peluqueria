<%-- 
    Document   : matizantes
    Created on : 11/10/2024, 9:54:09 p. m.
    Author     : aurcr
--%>
...
<body>
    ...
    <header>
        <h1>Nuestros Matizantes</h1>
    </header>

    <main class="products-container">
        <!-- Producto 1 -->
        <section class="product">
            <img src="https://saloninprofessional.com/wp-content/uploads/2022/02/Bodegon-intensifier12.png"  width="400" alt="Color Intensifier">
            <h2>COLOR INTENSIFIER</h2>
            <p>Hidrata y nutre el cabello con colorantes de última generación que se fijan en la fibra capilar, sin amoníaco. Especialmente formulados para reavivar el color natural del cabello o intensificar el color del cabello teñido.</p>
            <div class="price">$27,000</div> <!-- Precio del producto -->
